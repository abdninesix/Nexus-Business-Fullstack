...
import { CollaborationRequest } from '../../api/collaborations'; // <-- Import our new type
...
interface CollaborationRequestCardProps {
  ...
  // This prop will be connected to the useMutation hook in the dashboard
...
export const CollaborationRequestCard: React.FC<CollaborationRequestCardProps> = ({
  ...
  // The investor object is now populated and passed directly in the `request` prop
  const investor = request.investorId;

  // Safety check in case the investor data is missing
