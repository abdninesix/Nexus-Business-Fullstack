                ...
                toast.custom((t) => (
                    <div
                        className={`${t.visible ? 'animate-enter' : 'animate-leave'
                            } max-w-md w-full shadow-lg cursor-pointer rounded-lg pointer-events-auto flex`}
                        onClick={() => {
                            navigate(path);
                            toast.dismiss(t.id);
                        }}
                    >
                        ...
                        <div className="bg-white flex border-l border-gray-200">
                            <button
                                onClick={(e) => {
                                    e.stopPropagation(); // Prevent navigation
                                    toast.dismiss(t.id);
                                }}
                                className="w-full border border-transparent p-4 flex items-center justify-center text-sm font-medium text-primary-600 hover:text-primary-500 focus:outline-none focus:ring-2 focus:ring-primary-500"
                            >
                                Close
                            </button>
                        </div>
